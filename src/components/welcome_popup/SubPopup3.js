    ...
    return (
        <div>
            ...
            <form onSubmit={(e) => handleSubmit(e)}>
                ...
                <input id="confirmation" type="radio" name="lodging" value="true" onClick={(e) => {props.handleResponses(e)}} />
                ...
                <input id="denial" type="radio" name="lodging" value="false" onClick={(e) => {props.handleResponses(e)}} />
